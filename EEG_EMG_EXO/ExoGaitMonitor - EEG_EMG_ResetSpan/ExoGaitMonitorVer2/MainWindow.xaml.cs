                ...
                if (eeg_cm == 1)   //锁住eeg约3秒时间
                {
                    ...
                    while (i<10)
                    {
                        ...
                        while (j < 1999999999)
                        {
                            ...
                            if (emg_cm != 0)
                            { 
                                //Console.WriteLine("break啦");
                                ComWinTextBox.Dispatcher.Invoke(new showData(ComWinTextBox.AppendText), "break啦");
                                break;
                            }
                        }
                        if (emg_cm != 0) //为了跳出i循环
                    ...
                    {
                        eeg_cm = 2; 
                        ComWinTextBox.Dispatcher.Invoke(new showData(ComWinTextBox.AppendText), "等待完成");
                    }
